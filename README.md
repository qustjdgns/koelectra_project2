...
전체 데이터 중 **2,000건 이상**을 수동 라벨링 대상으로 선정하였다.  
무작위 샘플링과 전략적 샘플링을 병행하여 클래스 불균형을 완화하고, 중요 이슈 데이터를 충분히 확보하였다.
...
기능건의(0)     0.9258    0.9423    0.9340      1231
기술오류(1)     0.9674    0.9170    0.9415       711
정책비판(2)     0.8396    0.8761    0.8574       460
공지(3)        0.6914    0.6512    0.6707        86
기타(4)        0.9683    0.9683    0.9683      2493

accuracy                         0.9406      4981
macro avg      0.8785    0.8710    0.8744      4981
weighted avg   0.9410    0.9406    0.9406      4981
